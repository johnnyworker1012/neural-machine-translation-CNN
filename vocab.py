...
class VocabEntry(object):
    ...
    def words2charindices(self, sents):
        ...
        return [[([self.start_of_word] + [self.char2id[c] for c in word] + [self.end_of_word]) for word in sent] for sent in sents]
        ### END YOUR CODE
    ...
    def to_input_tensor_char(self, sents: List[List[str]], device: torch.device) -> torch.Tensor:
        ...
        char_sents_padded = pad_sents_char(self.words2charindices(sents), self.char2id['<pad>'])
